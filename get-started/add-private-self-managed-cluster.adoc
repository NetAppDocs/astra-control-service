...
Before you add the cluster, you need to install Astra Connector on the private cluster. Refer to link:install-astra-connector.html[Install Astra Connector for private clusters] for instructions.
