...
== Install Astra Connector
Before you add a private cluster, you need to install Astra Connector on the cluster so that Astra Control can communicate with it. Refer to link:install-astra-connector-legacy.html[Install Astra Connector for legacy private clusters] for instructions.
