...
[.lead]
The Astra beta program is integrated within NetApp Cloud Central's authentication service. Sign up to Cloud Central so you can access Astra and NetApp’s other cloud services.
...
+
TIP: You'll need to provide the email address that you enter in this form to the person who adds you to Astra.
+
