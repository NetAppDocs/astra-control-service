...
* You need Kubernetes administrator permissions.
...
* <PRIVATE_AKS_CLUSTER_NAME>: (AKS clusters only) - The cluster name of the private AKS cluster. Leave blank for other types of clusters.
* <ASTRA_CONTROL_ACCOUNT_ID>: Obtained from the Astra Control web UI, on the *Account > License* tab.
+
[source,yaml]
----
