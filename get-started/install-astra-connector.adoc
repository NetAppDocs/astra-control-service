...
[.lead]
Astra Control Service uses the Astra Connector to enable communication between Astra Control Service and private clusters. You need to install the Astra Connector on private clusters that you want to manage.

The Astra Connector supports the following types of private clusters:
...
* *ROSA clusters only*: After you install the Astra Connector on your ROSA cluster, the cluster is automatically added to Astra Control Service.
