...
= (Tech preview) Install the current Astra Connector for declarative managed clusters
:hardbreaks:
:icons: font
:imagesdir: ../media/get-started/

[.lead]
Clusters managed using the new architecture of Astra Control use Astra Connector to enable communication between the managed cluster and Astra Control. You need to install Astra Connector on all declarative clusters that you want to manage.
