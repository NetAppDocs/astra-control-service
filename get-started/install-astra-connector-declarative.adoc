...
[.lead]
Declarative Kubernetes clusters managed by Astra Control Service use Astra Connector to enable communication between the managed cluster and Astra Control Service. You need to install Astra Connector on all clusters that you want to manage.
