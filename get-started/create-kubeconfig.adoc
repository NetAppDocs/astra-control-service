...
[.lead]
To add a self-managed cluster, you need to create a kubeconfig file.
...
Follow the instructions in the Amazon documentation to create a kubeconfig file for Amazon EKS clusters:
