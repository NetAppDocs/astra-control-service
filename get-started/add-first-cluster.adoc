...
* Use the Astra Control web UI to assign a different default storage class. See link:../use/manage-buckets.html#change-the-default-bucket[Change the default bucket].
======================
