...
* Use the Astra Control Service web UI to assign a different default StorageClass:
...
. Select the *Actions* menu for the StorageClass you want to set as default.
