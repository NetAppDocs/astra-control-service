...
Ensure that clusters are healthy and running Kubernetes version 1.19 to 1.23, that node pools are online and running *Linux*, and more. <<Azure Kubernetes Service cluster requirements,Learn more about this step>>.
...
Kubernetes version:: Clusters must be running Kubernetes version 1.19 to 1.23.
