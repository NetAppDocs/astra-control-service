...
Private clusters must have the https://cloud.google.com/kubernetes-engine/docs/concepts/private-cluster-concept[master authorized network^] set to allow the Astra Control IP addresses:
...
Yes, Astra Control can manage clusters that reside in a shared VPC.
