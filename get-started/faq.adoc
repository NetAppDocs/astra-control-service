...
After you log in to https://console.cloud.google.com/[Google Cloud Console], your service account details will be in the *IAM and Admin* section. For more details, refer to link:set-up-google-cloud.html[how to set up Google Cloud for Project Astra.].
