...
. If you want to use the newly created bucket as default bucket for Azure backups, set it as default bucket for Azure using https://docs.netapp.com/us-en/astra-control-service/use/manage-buckets.html#change-the-default-bucket[Change the default bucket].
