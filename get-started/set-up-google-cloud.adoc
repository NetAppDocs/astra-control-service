...
[role="quick-margin-para"]
Go to the NetApp Cloud Volumes Service page in the Google Cloud Marketplace and click Purchase.

[role="quick-margin-para"]
<<Purchase Cloud Volumes Service for Google Cloud,Learn more about this step>>.
...
. https://cloud.google.com/solutions/partners/netapp-cloud-volumes/quickstart#purchase_the_service[Follow instructions in Google Cloud documentation to purchase and enable the service^].
