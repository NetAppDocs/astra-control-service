...
Ensure that clusters are healthy and running a Kubernetes version in the range of 1.17 to 1.20, that worker nodes are online and running Container-Optimized OS or Ubuntu, and more. <<GKE cluster requirements,Learn more about this step>>.
...
==== image:image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four] Create a service account that has the required permissions
