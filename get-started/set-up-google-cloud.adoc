...
Private clusters:: If the cluster is private, it must have the https://cloud.google.com/kubernetes-engine/docs/concepts/private-cluster-concept[master authorized network^] set to allow the Astra Control Service IP addresses:
*	54.164.233.140/32
*	3.218.120.204/32
*	34.193.99.138/32
