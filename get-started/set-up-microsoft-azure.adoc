...
. Optional: Test your service principal. Replace SUBSCRIPTION-ID with the ID of the resource group if you created the service principal with resource group scope.
+
[source,azurecli]
