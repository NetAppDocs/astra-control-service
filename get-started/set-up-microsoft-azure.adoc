...
==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Two] Register for Azure NetApp Files

[role="quick-margin-para"]
Register for the Azure NetApp Files service and then register the NetApp Resource Provider. <<Register for Azure NetApp Files,Learn more about this step>>.
...
Get access to Azure NetApp Files by registering for Microsoft Azure. After you register for the service, you'll need to register the NetApp Resource Provider.
...
. Select *Start free* and follow the instructions to complete the subscription.
...
After you've signed up, create a NetApp account in Azure NetApp Files.
