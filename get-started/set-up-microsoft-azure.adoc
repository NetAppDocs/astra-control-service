...
Ensure that clusters are healthy and running Kubernetes version 1.19 or later, that node pools are online and running *Linux*, and more. <<AKS cluster requirements,Learn more about this step>>.
...
.Steps for K8s version 1.20 and 1.21
