...
[role="quick-margin-para"]
If you plan to use Azure NetApp Files as a storage backend, register the NetApp Resource Provider. <<(Optional): Register for Azure NetApp Files,Learn more about this step>>.
...
== (Optional): Register for Azure NetApp Files
