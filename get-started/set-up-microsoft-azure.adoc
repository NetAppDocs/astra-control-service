...
[role="quick-margin-para"]
Subscribe to the Azure NetApp Files service and then register the NetApp Resource Provider. <<Register for Azure NetApp Files,Learn more about this step>>.
...
Get access to Azure NetApp Files by subscribing to Microsoft Azure. After you subscribe, you'll need to register the NetApp Resource Provider.
