...
//NOTE: Support for using Azure Managed Disks as a backend storage service is in initial preview status with this release.
...
==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png[Three] (Optional): Register for Azure NetApp Files

[role="quick-margin-para"]
If you plan to use Azure NetApp Files as a storage backend, register the NetApp Resource Provider. <<Register for Azure NetApp Files (optional),Learn more about this step>>.

==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png[Four] (Optional): Create a NetApp account

[role="quick-margin-para"]
If you plan to use Azure NetApp Files as a storage backend, go to Azure NetApp Files in the Azure portal and create a NetApp account. <<Create a NetApp account (optional),Learn more about this step>>.

==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five] (Optional): Set up capacity pools

[role="quick-margin-para"]
If you plan to use Azure NetApp Files as a storage backend, set up one or more capacity pools for your persistent volumes. <<Set up a capacity pool (optional),Learn more about this step>>.

==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png[Six] (Optional): Delegate a subnet to Azure NetApp Files

[role="quick-margin-para"]
If you plan to use Azure NetApp Files as a storage backend, delegate a subnet to Azure NetApp Files so that Astra Control Service can create persistent volumes in that subnet. <<Delegate a subnet to Azure NetApp Files (optional),Learn more about this step>>.
...
A Kubernetes cluster must meet the following requirements so you can discover and manage it from Astra Control Service. Note that some of these requirements only apply if you plan to use Azure NetApp Files as a storage backend.
...
Azure region:: If you plan to use Azure NetApp Files as a storage backend, clusters must reside in a region where Azure NetApp Files is available. https://azure.microsoft.com/en-us/global-infrastructure/services/?products=netapp[View Azure products by region^]. As a best practice, you should choose a region that supports Azure NetApp Files, even if you do not use it as a storage backend. This makes it easier to use Azure NetApp Files as a storage backend in the future if your performance requirements change.

Subscription:: If you plan to use Azure NetApp Files as a storage backend, clusters must reside in a subscription where Azure NetApp Files is enabled. You'll choose a subscription when you <<Register for Azure NetApp Files,register for Azure NetApp Files>>.

VNet::
If you plan to use Azure NetApp Files as a storage backend, consider the following:
...
== Register for Azure NetApp Files (optional)

If you plan to use Azure NetApp Files as a storage backend, get access to Azure NetApp Files by registering the NetApp Resource Provider.
...
== Create a NetApp account (optional)

If you plan to use Azure NetApp Files as a storage backend, create a NetApp account in Azure NetApp Files.
...
== Set up a capacity pool (optional)

If you plan to use Azure NetApp Files as a storage backend, one or more capacity pools are required so that Astra Control Service can provision persistent volumes in a capacity pool. Astra Control Service doesn't create capacity pools for you.
...
== Delegate a subnet to Azure NetApp Files (optional)

If you plan to use Azure NetApp Files as a storage backend, you need to delegate a subnet to Azure NetApp Files so that Astra Control Service can create persistent volumes in that subnet. Note that Azure NetApp Files enables you to have only one delegated subnet in a VNet.
