...
If you need to generate test data, we recommend using the methods outlined https://www.postgresql.org/docs/11/functions-srf.html[here in the Postgres documentation].
