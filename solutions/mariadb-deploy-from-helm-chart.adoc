...
Learn how to exercise the Project Astra beta program workflow by deploying MariaDB from a Helm chart. After you deploy MariaDB on your cluster, you can register the application with Project Astra.
