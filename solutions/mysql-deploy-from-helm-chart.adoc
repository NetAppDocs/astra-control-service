...
Learn how to exercise the Project Astra beta program workflow by deploying MySQL from a Helm chart. After you deploy MySQL on your cluster, you can register the application with Project Astra.
