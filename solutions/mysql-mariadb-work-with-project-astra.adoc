...
MariaDB and MySQL are validated apps for the Project Astra Beta program. link:../learn/validated-vs-standard.html[Learn the difference between Validated and Standard apps]
