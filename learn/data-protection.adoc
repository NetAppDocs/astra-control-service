...
* Amazon Elastic Kubernetes Service (EKS) using an Amazon S3 bucket with Object Lock configured
...
* NetApp StorageGRID using an S3 bucket with Object Lock configured
