...
+
You can refresh your screen to get a current snapshot of the process.
+
If you have any issues registering your serial number, contact us at astra.feedback@netapp.com.

== Obtain your serial number

When you register for an account, Astra uses the information that you provided about your company to generate a 20-digit NetApp serial number that starts with "941."
