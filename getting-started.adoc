...
*EJK - Add or link to detailed instructions for generating the SA JSON - maybe a section before this?

"Service account name" will be automatically generated, but you may change it if you wish. This value will appear in "Use existing" to identify available service account credentials.
