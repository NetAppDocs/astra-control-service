...
Choose the appropriate `.json` file and upload it. Otherwise, choose "Paste from Clipboard" or "Use existing."

image::astra-sa-file-uploaded.png[Service Account JSON File Uploaded]

"Service account name" will be automatically generated based on the `client_email` value contained in the service account JSON. You are welcome to change it if you wish. This value will appear under "Use existing" to identify this set of service account credentials.
