...
* Astra now creates Persistent Volumes that are 100 GiB.

* Astra can now discover apps faster.

* You can now create and delete accounts on your own.

* We've improved notifications when Astra can no longer access a Kubernetes cluster.
+
These notifications are important because Astra can't manage apps for disconnected clusters.
