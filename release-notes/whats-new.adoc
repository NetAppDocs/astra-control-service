...
After you install the link:../get-started/install-astra-connector.html[Astra Connector] on the cluster you want to manage, you'll be able to perform the following CR-based cluster operations in the UI or from a CR:
