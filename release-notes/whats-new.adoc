...
* Support for managing applications that are defined across multiple namespaces
+
link:../use/manage-apps.html[Define apps]
* Support for adding additional instances of cluster-scoped resources to your app definitions
+
link:../use/manage-apps.html[Define apps]
...
* Support for using the built-in task monitor to see the status of backup, restore, and clone operations
+
