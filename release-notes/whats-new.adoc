...
* You can now backup and restore `ontap-nas-economy`-backed applications with some link:../use/restore-apps.html#enable-backup-and-restore-for-ontap-nas-economy-operations[simple setup steps^].
