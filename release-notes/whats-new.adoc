...
Astra now supports the https://cloud.google.com/solutions/partners/netapp-cloud-volumes/service-types[CVS service type for Cloud Volumes Service for Google Cloud^]. This enhancement enables you to manage apps for Kubernetes clusters that reside in https://cloud.netapp.com/cloud-volumes-global-regions#cvsGcp[Google Cloud regions where CVS is supported^].

If you have the flexibility to select a Google Cloud region, then you can link:../learn/choose-class-and-size.html[choose between CVS and CVS-Performance based on your performance requirements].
