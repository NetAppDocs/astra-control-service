...
* You can now enable and disable Execution hooks for an Astra Control instance. Execution hooks are disabled by default with new Astra Control deployments.
+
