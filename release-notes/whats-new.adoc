...
* Support for apps that span across multiple namespaces and support for cluster resources that are associated with namespaced resources in addition to those that Astra Control includes automatically. 
+
