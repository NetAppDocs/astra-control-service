...
NOTE: If you have more than one backup for an app, only delete the most recent backups or all backups for an application. Otherwise, you will not be able to recover the app from a backup.
