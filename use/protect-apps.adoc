...
You can back up applications to immutable buckets. Astra Control Service supports immutable backups with the following platforms and immutable bucket types:
