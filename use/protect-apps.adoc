...
You can create immutable backups by backing up applications to immutable buckets. Refer to link:../learn/data-protection.html#immutable-backups[Data protection^] for important information about working with immutable backups.
