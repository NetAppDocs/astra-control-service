...
After you link:../get-started/add-first-cluster.html[a Kubernetes cluster to Project Astra], go to the Apps page to start managing the apps that run on the cluster.
