...
. *Restore details*: Specify details for the clone. To revert an app to an earlier version of itself, choose the same namespace and destination cluster that it is currently running in:
+
