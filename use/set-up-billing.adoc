...
NOTE: You can't upgrade the Astra Control Service account that you create through Astra Control Service to an Azure Marketplace PayGo or AWS Marketplace term-based offer account. When you subscribe to Astra Control Service through a Marketplace, you need to create a new Astra Control Service account (you can use the same e-mail address). The namespaces you managed through the initial Astra Control Service account can't be transferred to a Marketplace account.
