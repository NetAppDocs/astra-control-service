...
* *Confirm that your cluster has an AMD 64 system architecture*: The Astra Control Provisioner image is provided in both AMD and ARM architecture types, but only AMD is supported by Astra Control Service.
