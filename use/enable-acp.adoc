...
. If you have a custom registry, follow these steps for your preferred method to move the image to your custom registry. If you aren't using a registry, follow the Trident operator steps in the next section.
+
...
[source,console]
----
docker pull cr.astra.netapp.io/astra/trident-acp:23.10.0 --platform_string <cluster platform>
----
...
. If you removed the operator from your original deployment, create the Astra Trident orchestrator CRD again:
+
---- 
