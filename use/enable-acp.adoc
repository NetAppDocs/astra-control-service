...
. If you have a custom registry, follow these steps for your preferred method to move the image to your custom registry. If you aren't using a registry, follow the Trident operator steps in the link:../use/enable-acp.html#step-2-enable-astra-control-provisioner-in-astra-trident[next section].
+
