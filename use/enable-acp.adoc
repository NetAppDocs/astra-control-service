...
+
----
helm install trident netapp-trident/trident-operator --version <24.2.0> --set acpImage=<acp image> --set enableACP=true --create-namespace --namespace trident
----

* Images in one registry
+
----
helm install trident netapp-trident/trident-operator --version <24.2.0> --set acpImage=<acp image> --set enableACP=true --set imageRegistry=<your-registry>/sig-storage --create-namespace --namespace trident
----

* Images in different registries
+
----
helm install trident netapp-trident/trident-operator --version <24.2.0> --set acpImage=<acp image> --set enableACP=true --set imageRegistry=<your-registry>/sig-storage --set operatorImage=<your-registry>/netapp/trident-operator:24.02.0 --set tridentAutosupportImage=<your-registry>/netapp/trident-autosupport:24.02 --set tridentImage=<your-registry>/netapp/trident:24.02.0 --create-namespace --namespace trident
----
